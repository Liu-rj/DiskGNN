...
for i, row in enumerate(data):
    ...
    if i==0:
        ...
        statistics[0],statistics[1],statistics[2],statistics[3]=statistics[2],statistics[0],statistics[3],statistics[1]
        print(statistics)
        all_statistics.append(statistics)
        optimized_preprocessing=statistics[-2]
        tmp_statistics=[round(data/optimized_preprocessing,2) for data in statistics]
...
hatches = ["/////", "\\\\\\\\\\"]
labels = ['Primitive Preprocessing','Primitive Read','Optimized Preprocessing','Optimized Read']
...
for j in range(4):
    ...
    axes.bar_label(container, label_data, fontsize=11, zorder=200, fontweight="bold")
