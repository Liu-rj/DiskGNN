...
if __name__ == "__main__":
    ...
    dataset = DglLinkPropPredDataset(name=args.dataset, root="/efs/rjliu/dataset")
    ...
    val_loader, test_loader = loaders
    ...
    #         labels.append(y)
    #         if (it + 1) % 2000 == 0 or (it + 1) == len(train_loader):
    #             print(f"saving {len(pre_sampled_gs)} sampled subgraphs")
