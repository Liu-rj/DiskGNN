...
parser.add_argument(
    "--rootdir",
    type=str,
    default="/efs/rjliu/dataset",
    help="Directory to download the OGB dataset.",
)
parser.add_argument(
    "--author-output-path",
    type=str,
    default="/efs/rjliu/dataset/mag240m_kddcup2021/author.npy",
    help="Path to store the author features.",
)
parser.add_argument(
    "--inst-output-path",
    type=str,
    default="/efs/rjliu/dataset/mag240m_kddcup2021/inst.npy",
    help="Path to store the institution features.",
)
parser.add_argument(
    "--graph-output-path",
    type=str,
    default="/efs/rjliu/dataset/mag240m_kddcup2021/graph.dgl",
...
parser.add_argument(
    "--full-output-path",
    type=str,
    default="/efs/rjliu/dataset/mag240m_kddcup2021/full.npy",
