...
# ogbn-products
python train_online.py --dataset ogbn-products --fanout "10,15,20" --hidden 256 --dropout 0.2 --model SAGE --dir $data_path --ratio 1.0 --device 1 --num-epoch 100
python train_online.py --dataset ogbn-products --fanout "10,15,20" --hidden 16 --dropout 0.2 --model GAT --dir $data_path --ratio 1.0 --device 1 --num-epoch 100
