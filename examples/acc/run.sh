# # papers100M
# python train_online.py --dataset ogbn-papers100M --num-epoch 100 --hidden 512 --dropout 0.2 --dir /nvme2n1/offgs_dataset --model SAGE
# python train_offline.py --dataset ogbn-papers100M --num-epoch 100 --hidden 512 --dropout 0.2 --dir /nvme2n1/offgs_dataset --ratio 1.0 --model SAGE
...
# # mag240m
# python train_online.py --dataset mag240m --num-epoch 100 --model SAGE
...
# igb-full
# python train_online.py --dataset igb-full --num-epoch 5 --hidden 512 --dropout 0.2 --model SAGE
