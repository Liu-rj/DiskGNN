...
# sudo env PATH=$PATH python sampling.py --dataset ogbn-papers100M --fanout="10,10,10" --store-path /nvme1n1/offgs_dataset --ratio 1

# sudo env PATH=$PATH python feat_packing.py --dataset ogbn-papers100M --feat-cache-size=10000000000 --store-path /nvme1n1/offgs_dataset --ratio 1
