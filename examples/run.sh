...
# sudo /opt/conda/envs/SSD_GNN/bin/python feat_packing.py --dataset friendster --feat-cache-size=7000000000 --store-path /nvme1n1/offgs_dataset 
# sudo /opt/conda/envs/SSD_GNN/bin/python train_single_thread.py --dataset friendster --gpu-cache-size=1000000000 --cpu-cache-size=6000000000 --dir /nvme1n1/offgs_dataset 
...
# sudo /opt/conda/envs/SSD_GNN/bin/python merge_minibatch_train_single_thread.py --dataset igb-full --cpu-cache-size 15000000000 --gpu-cache-size 10000000000 --mega_batch_size 5000000000 --batchsize 1024 --fanout "10,10,10" --dir /nvme1n1/offgs_dataset --ratio 0.2 --sample-dir /nvme2n1/offgs_dataset
